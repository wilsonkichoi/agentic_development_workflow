# Phase 3: Task Breakdown — Prompt Template

## When to Use

After Phase 2 spec is reviewed and approved. Before any implementation begins.

## Recommended Model

Highest reasoning available. Good decomposition requires deep architectural understanding.
- Claude Code: `--model opus`
- Copilot CLI: Opus 4.6 (3x) — request-based billing absorbs the premium
...
- `templates/roles/README.md` (for role assignments)
...
8. Specify the recommended **role** for execution (see `templates/roles/README.md`).
...
#### [ ] Task 1.1: {{Title}}
- **Role:** {{role from templates/roles/}}
- **Depends on:** none
...
- If a decomposition decision involves 2+ viable approaches (e.g., wave grouping, task boundaries), create a decision record in `workflow/decisions/DR-NNN-title.md` and update `workflow/decisions/README.md`. See WORKFLOW.md § Decision Records for the template.
