# Phase 5: Verification & Retrospective — Prompt Template

## When to Use

After all tasks in the current milestone are complete and the human has reviewed and approved all PRs for the milestone.

## Recommended Model

Opus 4.6. Accurate retrospectives require deep understanding of what went wrong and why.
...
7. **Recommendations for Next Milestone**
   - Specific changes to prompts, templates, or role definitions
