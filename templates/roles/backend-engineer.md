...
Senior backend engineer focused on API implementation, data layer operations, and service logic.

## When to Use

- Phase 4: API endpoint tasks, service logic, database operations
