...
Senior frontend developer focused on component architecture, accessibility, responsive design, and user-facing implementation.

## When to Use

- Phase 4: Frontend component tasks, UI implementation, client-side logic
