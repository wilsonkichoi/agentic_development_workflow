...
Product-focused reviewer ensuring specifications deliver actual user value, with acceptance criteria that are user-centric rather than purely technical.

## When to Use

- Phase 2: When the system has user-facing features or multiple user personas
